...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      // style will be incorporated into the javascript
      // to have a separate file use another loader ExtractTextPlugin.extract("css!sass")
      // could be with a fall back ExtractTextPlugin.extract({
